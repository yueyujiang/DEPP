...
new_dir=build_tree/${2}_onecluster/`echo $line | sed "s/,/_/g"`
...
#		cat ${new_dir}/test_seqs/${gene}/query${c}.fa build_tree/${gene}/test_seqs_add_repr/${c}.fa > ${new_dir}/test_seqs/${gene}/${c}.fa
	...
	do
		...
		python ~/tool/get_tree_dist.py --treefile build_tree/${gene}/test_trees/${c}.nwk --outfile build_tree/${gene}/build_tree/backbone${c}.no_repr.csv
		python ~/tool/extend_csv.py --infile2 build_tree/${gene}/build_tree/backbone${c}.no_repr.csv --infile1 ${new_dir}/test_seqs/${gene}/depp${c}.csv --outfile ${new_dir}/test_seqs/${gene}/dist${c}.csv  #build_tree/${gene}/rep${rep}/build_tree/dist${c}.csv
